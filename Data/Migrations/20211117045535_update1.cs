    ...
    public partial class update1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GetMappedProducts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GetUserAddresses", x => x.UserAddressId);
                    table.ForeignKey(
                        name: "FK_GetUserAddresses_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GetOrderedItems", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GetProducts_CategoryCatId",
                table: "GetProducts",
                column: "CategoryCatId");

            migrationBuilder.CreateIndex(
                name: "IX_GetUserAddresses_AppUserId",
